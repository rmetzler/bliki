...
The Initial Set consists of rules i through xvi (immutable) and rules xvii through xxviii (mutable).

### Rule ii.

Initially rules i through xvi are immutable and rules xvii through xxviii are mutable.
...
If rule-changes can only be adopted unanimously, the voting may be ended as soon as an opposing vote is counted.
If and when rule-changes can be adopted without unanimity, the voting may be ended as soon as a simple majority in favour or a simple majority against is counted.
